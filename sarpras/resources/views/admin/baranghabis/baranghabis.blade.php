            ...
            <div class="container">
                ...
                <div class="row mt-3">
                    <div class="col-lg-6 sm-4">
                        <a href="/tambahbaranghabis" class="btn btn-outline-primary">Tambah Barang</a><br><br>
                        ...
                        <table class="table table-bordered" id="gas">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="/tampilkanbaranghabis/{{ $row->id }}" type="button" class="btn btn-sm btn-warning text-white"><i class="ti-eraser" title="Ubah"></i></a>
