...
<head>
	...
	<!-- Style css -->
    <link href="{{ asset('index1/vendor/jqvmap/css/jqvmap.min.css') }}" rel="stylesheet">
	<link rel="stylesheet" href="{{ asset('index1/vendor/chartist/css/chartist.min.css') }}">
    <link href="{{ asset('index1/vendor/bootstrap-select/dist/css/bootstrap-select.min.css') }}" rel="stylesheet">
	<link href="{{ asset('index1/css/style.css') }}" rel="stylesheet">
	<link href="{{ asset('index1/cdn.lineicons.com/2.0/LineIcons.css') }}" rel="stylesheet">
...
<body>
    ...
    ***********************************-->
    <div id="main-wrapper">
        ...
        ***********************************-->
        <div class="nav-header">
            <a href="index.html" class="brand-logo">
                <img class="logo-abbr" src="{{ asset('index1/images/logo-white.png') }}" alt="">
                <img class="logo-compact" src="{{ asset('index1/images/logo-text.png') }}" alt="">
                <img class="brand-title" src="{{ asset('index1/images/logo-text.png') }}" alt="">
            </a>
				...
				<div class="tab-content" id="menu">
						...
						<ul class="metismenu tab-nav-menu">
							...
							<li>
								<a class href="javascript:void()" aria-expanded="false">
									<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1"><g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd"><rect x="0" y="0" width="24" height="24"/>
								</svg>
								</a>
                                </a>
							</li>
					...
					<div class="tab-pane fade" id="table">
						<ul class="metismenu tab-nav-menu">
							...
							<li><a href="{{ asset('index1/table-datatable-basic.html')}}">
                        ...
                        <ul class="navbar-nav header-right">
                            ...
                            <li class="nav-item dropdown header-profile">
                                <a class="nav-link" href="#" role="button" data-toggle="dropdown">
                                    <img src="{{ asset('index1/images/profile/oh.png')}}" width="20" alt=""/>
									<div class="header-info">
										<span>Halo,<strong>User</strong></span>
										<small>Profil</small>
									</div>
                                </a>
        ...
        ***********************************-->
        <div class="footer">
            <div class="copyright">
                <p>Copyright © Desain &amp; Oleh <a href="http://dexignlab.com/" target="_blank">Gantari</a> 2022</p>
            </div>
        </div>
        <!--**********************************
            Footer end
    ...
    ***********************************-->
    <!-- Required vendors -->
    <script src="{{ asset('index1/vendor/global/global.min.js') }}"></script>
	<script src="{{ asset('index1/vendor/bootstrap-select/dist/js/bootstrap-select.min.js') }}"></script>
    <script src="{{ asset('index1/vendor/chart.js/Chart.bundle.min.js') }}"></script>
    <script src="{{ asset('index1/js/custom.min.js') }}"></script>
	<script src="{{ asset('index1/js/deznav-init.js') }}"></script>
	<!-- Apex Chart -->
	<script src="{{ asset('index1/vendor/apexchart/apexchart.js') }}"></script>

    <!-- Vectormap -->
	<!-- Chart piety plugin files -->
    <script src="{{ asset('index1/vendor/peity/jquery.peity.min.js') }}"></script>

    <!-- Chartist -->
    <script src="{{ asset('index1/vendor/chartist/js/chartist.min.js') }}"></script>

	<!-- Dashboard 1 -->
	<script src="{{ asset('index1/js/dashboard/dashboard-1.js') }}"></script>
	<!-- Svganimation scripts -->
	<script src="{{ asset('index1/vendor/svganimation/vivus.min.js') }}"></script>
    <script src="{{ asset('index1/vendor/svganimation/svg.animation.js') }}"></script>
