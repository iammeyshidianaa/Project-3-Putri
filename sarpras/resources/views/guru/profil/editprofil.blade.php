            ...
            <div class="col-md-12 grid-margin stretch-card">
                <div class="card">
                    ...
                    <form class="forms-sample">
                        ...
                        <div class="form-group row">
                        <label for="exampleInputConfirmPassword2" name="foto1" class="col-sm-3 col-form-label">Foto</label>
                        <div class="col-sm-9">
                            <input type="file" class="form-control" name="foto1" id="exampleInputConfirmPassword2" placeholder="">
                        </div>
                        </div>
                        <button type="submit" class="btn btn-primary mr-2">Simpan</button>
                        <a href="/profileguru" class="btn btn-light">Kembali</a>
                    </form>
                    </div>
                </div>
            </div>
