...
<body>
    <div class="content-wrapper">
        ...
        <h2 class="text-center text-primary">Ajukan Peminjaman Barang Habis</h2>
        <form action="/insertpinjam_guru2" method="POST" enctype="multipart/form-data">
            @csrf
            <br><br>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <select id="ya" name="namabarang3" class="form-control">
                        @foreach($namabarangs as $p)
                            <option value="{{ $p->nama_barang1 }}">{{ $p->nama_barang1 }}</option>
                        @endforeach
                    </select>
                </div>
                <div class="mb-3">
